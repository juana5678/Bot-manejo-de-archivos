...
@bot.on_message(filters.command("educaj", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("uclvh", prefixes="/")& filters.private)
async def uclvh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
@bot.on_message(filters.command("cloudh", prefixes="/")& filters.private)
async def cloudh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
@bot.on_message(filters.command("perfil_myh", prefixes="/")& filters.private)
async def perfil_myh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
@bot.on_message(filters.command("uvs_ucmh", prefixes="/")& filters.private)
async def uvs_ucmh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
async def gtm(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
	...
	await send_config()
	await send("**Nube ☁️ Seleccionala > GTM**")

@bot.on_message(filters.command("uvs", prefixes="/")& filters.private)
async def uvs(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
	...
	Configs[username]["z"] = 100
	await send_config()
	await send("**Nube ☁️ Seleccionala > UVS.LTU**")

@bot.on_message(filters.command("perfilh", prefixes="/")& filters.private)
async def perfilh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
@bot.on_message(filters.command("nubeh", prefixes="/")& filters.private)
async def nubeh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
@bot.on_message(filters.command("acc", prefixes="/")& filters.private)
async def acc(client: Client, message: Message):	
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
#borrados
@bot.on_message(filters.command("delete_proc_myh", prefixes="/")& filters.private)
async def delete_myh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
@bot.on_message(filters.command("delete_proch", prefixes="/")& filters.private)
async def delete_adminh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
@bot.on_message(filters.command("nex_deleteh", prefixes="/")& filters.private)
async def delete_nexh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
	except:await send_config()
...
@bot.on_message(filters.command("deletelinksh", prefixes="/")& filters.private)
async def delete_linksh(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
...
def comprobar_solo_un_proceso(username):
	if id_de_ms[username]["proc"] == "Up" :
		rup = "`Ya Tiene una Subida Activa. Si desea Cancelarla use` **/cancel**"
		return rup
	else:
		return False
