...
async def callback(bot, msg: CallbackQuery):
    ...
    if msg.data == "nubes":
        ...
        await msg.message.edit(
            text="Hola 👋🏻 a SUPERMANBOT, Bienvenido a este sistema de Descargas, estamos simpre para tí, y ayudarte a descagar cualquier archivo multimedia que desees☺️",
            reply_markup=hom
        )
...
async def text_filter(client, message):
    ...
    if "youtu.be/" in message.text or "twitch.tv/" in message.text or "youtube.com/" in message.text or "xvideos.com" in message.text or "xnxx.com" in message.text:
        ...
        await bot.send_photo(username,"logo.jpg",caption="`Hola 👋🏻 a Supermanbot, Bienvenido a este sistema de Descargas, estamos simpre para tí, y ayudarte a descagar cualquier archivo multimedia que desees☺️`",
            reply_markup=hom)
